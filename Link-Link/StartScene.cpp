 ...
 *
 */
StartScene::StartScene() { sprintf(background_pic, "./Pic/startgame.png"); }
...
void StartScene::onMouseMotion(Sint32 x, Sint32 y) {
    ...
    if (x >= 400 && x <= 560 && y >= 300 && y <= 350) {
        /*开始游戏按钮.*/
        sprintf(background_pic, "./Pic/startgame_stroke1.png");
    } else if (x >= 400 && x <= 560 && y >= 360 && y <= 410) {
        /*设置按钮.*/
        sprintf(background_pic, "./Pic/startgame_stroke2.png");
    } else if (x >= 400 && x <= 560 && y >= 430 && y <= 470) {
        /*关于按钮.*/
        sprintf(background_pic, "./Pic/startgame_stroke3.png");
    } else if (x >= 400 && x <= 560 && y >= 490 && y <= 540) {
        /*退出按钮.*/
        sprintf(background_pic, "./Pic/startgame_stroke4.png");
    } else {
        /*鼠标在其他位置，不显示按钮.*/
        sprintf(background_pic, "./Pic/startgame.png");
    }
}